...
💡 এই উদাহরণ থেকে কী শিখলেন? <br> 
    টাইপ সেফটি: আমরা List<Product> এবং Dictionary<int, Product> তৈরি করেছি। এতে নিশ্চিত হলো যে এই কালেকশনগুলিতে ভুল করে অন্য কোনো টাইপের ডেটা (যেমন শুধু int বা string) যোগ করা যাবে না। এটি কম্পাইল করার সময়ই ত্রুটি ধরে ফেলে। <br>
    সহজ ব্যবহার: ডেটা অ্যাক্সেস করার সময় আপনাকে টাইপ কাস্টিং (Type Casting) করতে হচ্ছে না (যেমনটা নন-জেনেরিক ArrayList-এ করতে হতো)। যখন আমরা foreach (var product in productList) লুপ করি, তখন product সরাসরি একটি Product অবজেক্ট হিসেবেই আসে। <br>
    দক্ষতা (Efficiency): Dictionary<TKey, TValue> আমাদেরকে Key ব্যবহার করে অতি দ্রুত (সাধারণত O(1) সময়ে) ডেটা খুঁজে বের করার সুবিধা দেয়, যা ডেটাবেস অ্যাপ্লিকেশনগুলির জন্য খুবই কার্যকর। <br>
